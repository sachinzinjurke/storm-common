...
public final class TopologySubmitter {
	...
	private static void submitTopologies(final TopologySubmission topologySubmission, String topologyName, int config)throws AlreadyAliveException, InvalidTopologyException {
